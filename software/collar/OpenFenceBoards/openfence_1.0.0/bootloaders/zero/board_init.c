...
void board_init(void)
{
   ...
   * 2) Put XOSC32K as source of Generic Clock Generator 1
   */
  GCLK->GENDIV.reg = GCLK_GENDIV_ID( GENERIC_CLOCK_GENERATOR_OSCULP32K ); // Generic Clock Generator 1
  ...
  GCLK->GENCTRL.reg = GCLK_GENCTRL_ID( GENERIC_CLOCK_GENERATOR_OSCULP32K ) | // Generic Clock Generator 1
                      GCLK_GENCTRL_SRC_OSCULP32K | // Selected source is Internal 32KHz Oscillator
